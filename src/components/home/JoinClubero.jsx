...
import bgImg from "../../assets/join-meetup.webp";

const JoinClubero = () => {
  return (
    <div className="mx-auto max-w-[1020px] mb-30 rounded-2xl relative overflow-hidden">
      <img
      ...
      <div className="relative z-10 bg-linear-to-br from-accent/15 to-accent/10  py-20 rounded-2xl flex flex-col items-center justify-center border border-black/10 px-4">
        ...
        <p className="my-6 w-full text-info md:w-120 text-center">
          People use Clubero to meet new people, learn new things, find support,
