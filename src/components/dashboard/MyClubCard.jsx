  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-3xl">
        ...
        />
        <p
          className={`absolute top-3 left-3 bg-white text-black text-xs font-semibold px-3 py-1 rounded-full z-10    ${
      ...
      <p className="text-[12px] my-1 items-center gap-1 font-[Neusans-medium] text-[#69696C]">
