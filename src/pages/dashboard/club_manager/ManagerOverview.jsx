...
import { FaUsers, FaCalendarAlt, FaUniversity, FaMoneyBillWave } from "react-icons/fa";
     ...
     <h2 className="heading relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat, idx) => (
          <motion.div
            key={idx}
            className={`${stat.bg} flex items-center p-6 rounded-xl shadow-lg hover:shadow-2xl transition`}
